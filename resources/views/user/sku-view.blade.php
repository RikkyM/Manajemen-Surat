...
<body>
    ...
    <table style="width: 100%; margin-top: 20px;">
        <tr>
            <td style="text-align: center; font-size: 13px;">
                <h2 style="border-bottom: solid 2px black;">SURAT KETERANGAN USAHA</h2>
            </td>
        </tr>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="padding: 5px 0; width: 250px;">3. Jenis Kelamin</td>
            <td>: {{ $data['data']->jenis_kelamin }}</td>
        </tr>
        <tr>
            <td style="padding: 5px 0; width: 250px;">4. Tempat & Tanggal Lahir</td>
            <td>: {{ $data['data']->tempat_lahir }}, {{ $data['data']->tanggal_lahir->format('d-m-Y') }}</td>
        </tr>
        <tr>
            <td style="padding: 5px 0; width: 250px;">5. Kewarganegaraan</td>
            <td>: {{ $data['data']->kewarganegaraan }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="padding: 5px 0; width: 250px;">8. Tempat Tinggal</td>
    ...
    <div style="margin-left: -18px">
        <ol type="a">
            <li style="text-align: justify; margin: 10px 0; line-height: 20px">
                Bahwa benar yang bersangkutan penduduk Desa Tirto Sari Kecamatan banyuasin I Kabupaten Banyuasin dan
                berdomisili sebagai mana alamat tersebut diatas.
            </li>
            <li style="text-align: justify; margin: 10px 0; line-height: 30px">
                Bahwa benar berdasarkan surat pengantar dari ketua Rt 021 Dusun 005 Desa Tirto Sari yang bersangkutan
                memiliki usaha.
            </li>
        </ol>
    </div>

    <p style="text-indent: 30px; line-height: 30px;">Demikian surat keterangan usaha ini dibuat dengan sebenar-benarnya untuk dapat memenuhi persyaratan-persyaratan yang di perlukan sebagaimana mestinya.</p>
