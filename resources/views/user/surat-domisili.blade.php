        ...
        <div class="flex-1 overflow-y-auto">
            <div class="w-full p-8">
                ...
                <div class="h-full w-full p-2">
                    ...
                    <form action="{{ route('user.surat.domisili') }}" method="POST" class="grid-rows-8 grid grid-cols-8 gap-5" enctype="multipart/form-data">
                        @csrf
                        ...
                        <label for="kk" class="relative left-0 col-span-4 flex h-max w-full flex-col">
                            <input type="text" id="kk" name="kk" placeholder="" autocomplete="off"
                                value="{{ old('kk') }}" maxlength="16"
                                class="peer w-72 w-full rounded-md border border-black/30 p-2">
                            <span
                                class="absolute -top-2 left-2 h-max w-max bg-white px-0.5 text-xs transition-[font,inset] after:text-red-500 after:content-['*'] peer-placeholder-shown:inset-y-2 peer-placeholder-shown:text-base peer-focus:-top-2 peer-focus:text-xs">No.
                                KK</span>
                            @error('kk')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
