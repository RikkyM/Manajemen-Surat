        ...
        <div class="flex-1 overflow-y-auto">
            <div class="w-full p-8">
                ...
                <div class="h-full w-full p-2">
                    ...
                    <form action="{{ route('user.surat.kematian') }}" method="POST" enctype="multipart/form-data"
                        class="grid-rows-7 grid grid-cols-8 gap-5">
                        @csrf
                        ...
                        <label for="tanggal" class="relative left-0 col-span-2 flex h-max w-full flex-col">
                            <input type="date" id="tanggal" name="tanggal" placeholder="" autocomplete="off"
                                value="{{ old('tanggal') }}"
                                class="peer w-72 w-full rounded-md border border-black/30 p-2">
                            <span
                                class="absolute -top-2 left-2 h-max w-max bg-white px-0.5 text-xs transition-[font,inset] after:text-red-500 after:content-['*'] peer-placeholder-shown:inset-y-2 peer-placeholder-shown:text-base peer-focus:-top-2 peer-focus:text-xs">Tanggal</span>
                            @error('tanggal')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </label>
                        <label for="jam" class="relative left-0 col-span-2 flex h-max w-full flex-col">
                            <input type="time" id="jam" name="jam" placeholder="" autocomplete="off"
                                value="{{ old('jam') }}" class="peer w-72 w-full rounded-md border border-black/30 p-2">
                            <span
                                class="absolute -top-2 left-2 h-max w-max bg-white px-0.5 text-xs transition-[font,inset] after:text-red-500 after:content-['*'] peer-placeholder-shown:inset-y-2 peer-placeholder-shown:text-base peer-focus:-top-2 peer-focus:text-xs">Waktu</span>
                            @error('jam')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </label>
                        <label for="tempat_meninggal" class="relative left-0 col-span-4 flex h-max w-full flex-col">
                            <input type="text" id="tempat_meninggal" name="tempat_meninggal" placeholder=""
                                value="{{ old('tempat_meninggal') }}" autocomplete="off"
                                class="peer w-72 w-full rounded-md border border-black/30 p-2">
                            <span
                        ...
                        <label for="upload_kk" class="relative left-0 col-span-2 col-start-4 flex h-max w-full flex-col">
